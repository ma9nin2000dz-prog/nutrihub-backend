...
>
  ...
  style={{
    marginTop:15,
    //backgroundColor: selected ? color : "#1f2937", {selected ? "Selected" : "Select"}  "#111827"
    backgroundColor: selected ? "#0f172a" : "#1f2937",
    padding:10,
    borderRadius:12,
    alignItems:"center"
  }}
...
<TouchableOpacity
  ...
  style={[
    ...
    {
      backgroundColor:
        calorieGoalType === "cutting" ? "#eeebeb" : "#111827"
    }
  ]}
...
<TouchableOpacity
   style={[
    ...
    {
     backgroundColor:
      calorieGoalType === "maintenance" ? "#eeebeb" : "#111827"
    }
  ]}
...
>
  ...
  <Text style={[styles.cardValue,{ color:
   ...
   style={[
    ...
    {
     backgroundColor:
  calorieGoalType === "bulking" ? "#eeebeb" : "#111827"
    }
  ]}
