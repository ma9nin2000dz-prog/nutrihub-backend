...
onPress={()=>{
  ...
  {
    ...selectedItem,
    selectedServings: selectedItem.servings || 1
  }
]
  ...
  {isRecipe ? (
    <>
      <Text style={styles.extraText}>
        Difficulty : {selectedItem.difficulty || "easy"}
      </Text>
...
<Text style={styles.macros}>
  <Text style={styles.macrosss}>
    🔥 {Math.round(selectedItem.nutrition?.energyKcal || 0)} Kcal 
    </Text>
